              ...
              <div class="row gx-5">
                ...
                @foreach ($post as $item)
                  ...
                  <div class="col-sm-6 col-lg-4 mb-5">
                    <a href="{{ route('f-post',['post'=>$item->id])}} "class="related-content card text-decoration-none overflow-hidden h-100">
                        <img class="related-img card-img-top" src="{{asset('uploads/post/'.$item->image )}}"  alt="Card image cap" style="object-fit:cover;">
