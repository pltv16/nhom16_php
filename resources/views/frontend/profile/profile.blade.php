...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span> Tài khoản</h4>
    ...
    <div class="row">
      <div class="col-md-12">
        <ul class="nav nav-pills flex-column flex-md-row mb-3 nav-fill">
          <li class="nav-item">
            <a class="nav-link active" href="{{ route('f-profile') }}"><i class="bx bx-user me-1"></i> Quản lý</a>
            
          </li>
          
          <li class="nav-item">
            <a class="nav-link " href="{{ route('f-manage') }}"><i class="bx bx-user me-1"></i> Tài khoản</a>
          </li>
        </ul>
        <div class="card mb-4">
