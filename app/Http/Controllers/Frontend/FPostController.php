...
class FPostController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('frontend/f-add-post')->with('message','Thêm bài viết thành công');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('frontend/f-add-post')->with('message','Cập nhật bài viết thành công'); 
    }
